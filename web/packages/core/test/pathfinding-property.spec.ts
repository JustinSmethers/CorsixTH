...
function neighborsOf(position: GridPosition, width: number, height: number): GridPosition[] {
  const candidates = [
...
function bfsShortestLength(map: TileMap, start: GridPosition, goal: GridPosition): number | null {
...
function assertPathIsValid(path: GridPosition[], map: TileMap, start: GridPosition, goal: GridPosition): void {
