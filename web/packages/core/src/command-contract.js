...
function isRoomType(value) {
    return value === "diagnosis" || value === "treatment" || value === "pharmacy" || value === "specialist" || value === "psychiatry" || value === "inflation-room" || value === "slack-tongue-clinic" || value === "fracture-clinic" || value === "hair-restoration" || value === "jelly-vat" || value === "decontamination" || value === "electrolysis" || value === "dna-fixer";
}
