...
function isRoomType(value) {
    return value === "diagnosis" || value === "treatment" || value === "pharmacy" || value === "specialist" || value === "inflation-room" || value === "fracture-clinic" || value === "hair-restoration" || value === "dna-fixer";
}
