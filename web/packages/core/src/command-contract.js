...
function isRoomType(value) {
    return value === "diagnosis" || value === "cardiogram" || value === "scanner" || value === "ultrascan" || value === "blood-machine" || value === "x-ray" || value === "general-diagnosis" || value === "treatment" || value === "ward" || value === "pharmacy" || value === "operating-theatre" || value === "specialist" || value === "psychiatry" || value === "inflation-room" || value === "slack-tongue-clinic" || value === "fracture-clinic" || value === "hair-restoration" || value === "jelly-vat" || value === "decontamination" || value === "electrolysis" || value === "dna-fixer";
}
