...
const ORIGINAL_UI_STRIP_CONTROLS = [
    ...
    { id: "build-specialist-room", label: "Build Specialist" },
    ...
    { id: "open-furnish-corridor", label: "Furnish Corridor" },
    { id: "open-edit-room", label: "Edit Room" },
    { id: "open-first-message", label: "Messages" },
    { id: "open-casebook", label: "Casebook" },
    { id: "open-map", label: "Map" },
    { id: "open-staff", label: "Staff" },
    { id: "open-research", label: "Research Panel" },
    { id: "open-policy", label: "Policy" },
    { id: "open-machine-menu", label: "Machine Menu" },
