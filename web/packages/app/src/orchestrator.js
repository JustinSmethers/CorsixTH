...
const ALLOWED_ROOM_TYPES = ["diagnosis", "treatment", "pharmacy", "specialist", "inflation-room", "slack-tongue-clinic", "fracture-clinic", "hair-restoration", "jelly-vat", "dna-fixer"];
...
export class AppOrchestrator {
    ...
    telemetry() {
        ...
        return {
            ...
            openJellyVatRooms,
            openDnaFixerRooms,
            specializedTreatmentRooms: openPharmacyRooms + openSpecialistRooms + openInflationRooms + openSlackTongueClinicRooms + openFractureClinicRooms + openHairRestorationRooms + openJellyVatRooms + openDnaFixerRooms,
