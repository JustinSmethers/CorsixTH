...
const ALLOWED_ROOM_TYPES = ["diagnosis", "treatment", "pharmacy", "specialist", "inflation-room", "slack-tongue-clinic", "fracture-clinic", "hair-restoration", "dna-fixer"];
...
export class AppOrchestrator {
    ...
    telemetry() {
        ...
        return {
            ...
            openDnaFixerRooms,
            specializedTreatmentRooms: openPharmacyRooms + openSpecialistRooms + openInflationRooms + openSlackTongueClinicRooms + openFractureClinicRooms + openHairRestorationRooms + openDnaFixerRooms,
