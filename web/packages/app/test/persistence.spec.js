...
describe("app persistence integration", () => {
    it("creates save envelopes from orchestrator snapshots and restores equivalent telemetry", () => {
        ...
        const orchestrator = new AppOrchestrator({
            ...
            roomAvailability: ["operating-theatre", "staff-room", "research", "toilets"],
            roomAvailabilitySchedule: [
                { index: 24, roomType: "operating-theatre", startAvailable: false, whenAvailable: 1, availableForLevel: true },
                { index: 25, roomType: "staff-room", startAvailable: true, whenAvailable: 0, availableForLevel: true },
                { index: 26, roomType: "research", startAvailable: false, whenAvailable: 2, availableForLevel: true },
                { index: 27, roomType: "toilets", startAvailable: true, whenAvailable: 0, availableForLevel: true }
            ],
            roomCostOverrides: { diagnosis: 2_280, treatment: 1_700, pharmacy: 500, "operating-theatre": 1_500, "staff-room": 1_500, research: 4_000, toilets: 800 },
        ...
        expect(envelope.payload.roomAvailability).toEqual(["diagnosis", "treatment", "operating-theatre", "staff-room", "research", "toilets"]);
        ...
        expect(envelope.payload.roomCostOverrides).toEqual({ diagnosis: 2_280, treatment: 1_700, pharmacy: 500, "operating-theatre": 1_500, "staff-room": 1_500, research: 4_000, toilets: 800 });
        expect(envelope.payload.roomWearThresholdOverrides).toEqual({ diagnosis: 12, "operating-theatre": 8, "staff-room": 8, research: 9, toilets: 7 });
