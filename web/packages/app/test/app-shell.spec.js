...
describe("app shell campaign objectives", () => {
    ...
    it("uses imported room names and scenario costs in build labels", () => {
        expect(["diagnosis", "blood-machine", "treatment", "pharmacy", "specialist", "psychiatry", "inflation-room", "slack-tongue-clinic", "fracture-clinic", "hair-restoration", "jelly-vat", "decontamination", "electrolysis", "dna-fixer"].map((roomType) => formatBuildRoomButtonLabel(roomType).replace(/\s+\(\d+\)$/, ""))).toEqual([
            "Build Diagnosis",
            "Build Blood Machine",
            "Build Treatment",
            "Build Pharmacy",
    ...
    it("formats queue pressure thresholds and penalties for the browser HUD", () => {
        ...
        expect(formatSpecializedTreatmentRoomsStatus({
            ...
            openDnaFixerRooms: 3
        })).toBe("Specialized rooms: pharmacy 1, specialist 2, Psychiatry 1, Inflation Room 1, Slack Tongue Clinic 1, Fracture Clinic 1, Hair Restoration 1, Jelly Vat 1, Decontamination 1, Electrolysis 1, DNA Fixer 3");
