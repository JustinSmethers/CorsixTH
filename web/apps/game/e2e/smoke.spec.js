...
test("phase 7 keyboard shortcuts save and load active slot", async ({ page }) => {
    ...
    await page.keyboard.press("KeyG");
    await expect(page.getByTestId("furnish-corridor-panel")).toBeVisible();
    await expect(page.locator(":focus")).toHaveAttribute("data-testid", /furnish-corridor-(object|panel-close)/);
    await expect(page.getByTestId("cash")).toHaveText(cashBeforeFurnishFocus);
    await expect(page.getByTestId("action-status")).toHaveText("Action: furnish corridor opened");
    await expect(page.getByTestId("object-availability")).toHaveText(objectAvailabilityBeforeFocus);
    await expect(page.getByTestId("furnish-corridor-panel-summary")).toContainText("Corridor objects:");
    await page.keyboard.press("Escape");
    await expect(page.getByTestId("furnish-corridor-panel")).toBeHidden();
    await expect(page.locator(":focus")).toHaveAttribute("data-testid", "playfield");
    await expect(page.getByTestId("action-status")).toHaveText("Action: furnish corridor closed");
    await page.getByTestId("playfield").focus();
    ...
    await page.keyboard.press("KeyV");
    await expect(page.getByTestId("edit-room-panel")).toBeVisible();
    await expect(page.locator(":focus")).toHaveAttribute("data-testid", /edit-room-panel-(toggle|repair|sell|close)/);
    await expect(page.getByTestId("cash")).toHaveText(cashBeforeEditRoomFocus);
    await expect(page.getByTestId("action-status")).toHaveText("Action: edit room opened");
    await expect(page.getByTestId("room-availability")).toHaveText(roomAvailabilityBeforeFocus);
    await expect(page.getByTestId("edit-room-panel-summary")).toContainText("Edit room:");
    await expect(page.getByTestId("edit-room-panel-availability")).toHaveText(roomAvailabilityBeforeFocus);
    await page.keyboard.press("Escape");
    await expect(page.getByTestId("edit-room-panel")).toBeHidden();
    await expect(page.locator(":focus")).toHaveAttribute("data-testid", "playfield");
    await expect(page.getByTestId("action-status")).toHaveText("Action: edit room closed");
    await page.getByTestId("playfield").focus();
    ...
    await page.getByTestId("policy-panel-admission-policy").focus();
    await page.keyboard.press("F4");
    ...
    const recentEventsBeforeMessagePanel = (await page.getByTestId("recent-events").textContent()) ?? "";
    await page.keyboard.press("KeyM");
    await expect(page.getByTestId("message-panel")).toBeVisible();
    await expect(page.locator(":focus")).toHaveAttribute("data-testid", "message-panel-close");
    await expect(page.getByTestId("cash")).toHaveText(cashBeforeMessageFocus);
    await expect(page.getByTestId("message-panel-last")).toHaveText(lastEventBeforeMessageFocus);
    await expect(page.getByTestId("message-panel-recent")).toHaveText(recentEventsBeforeMessagePanel);
    ...
    await expect(page.getByTestId("action-status")).toHaveText("Action: message closed");
    await page.getByTestId("playfield").focus();
