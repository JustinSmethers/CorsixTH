...
test("phase 7 slice 2 player journey: specialized treatment rooms route matching diseases", async ({ page }) => {
    await importAssetsAndEnterPlayableShell(page);
    await page.getByTestId("pause-toggle").click();
    await expect(page.getByTestId("specialized-treatment-rooms")).toHaveText("Specialized rooms: pharmacy 0, specialist 0, Inflation Room 0, Slack Tongue Clinic 0, Fracture Clinic 0, Hair Restoration 0, Jelly Vat 0, DNA Fixer 0");
    await page.getByTestId("treatment-room-toggle").click();
    await expect(page.getByTestId("open-treatment-rooms")).toHaveText("Open treatment rooms: 0");
    ...
    await expect(page.getByTestId("specialized-treatment-rooms")).toHaveText("Specialized rooms: pharmacy 1, specialist 0, Inflation Room 0, Slack Tongue Clinic 0, Fracture Clinic 0, Hair Restoration 0, Jelly Vat 0, DNA Fixer 0");
    await expect(page.getByTestId("open-treatment-rooms")).toHaveText("Open treatment rooms: 1");
...
test("phase 7 slice 2 player journey: specialist rooms can be built from browser controls", async ({ page }) => {
    ...
    await expect(page.getByTestId("action-status")).toHaveText("Action: room built");
    await expect(page.getByTestId("specialized-treatment-rooms")).toHaveText("Specialized rooms: pharmacy 0, specialist 1, Inflation Room 0, Slack Tongue Clinic 0, Fracture Clinic 0, Hair Restoration 0, Jelly Vat 0, DNA Fixer 0");
    await expect(page.getByTestId("open-treatment-rooms")).toHaveText("Open treatment rooms: 1");
...
test("phase 7 slice 2 player journey: Slack Tongue Clinic can be built from browser controls", async ({ page }) => {
    ...
    await expect(page.getByTestId("action-status")).toHaveText("Action: room built");
    await expect(page.getByTestId("specialized-treatment-rooms")).toHaveText("Specialized rooms: pharmacy 0, specialist 0, Inflation Room 0, Slack Tongue Clinic 1, Fracture Clinic 0, Hair Restoration 0, Jelly Vat 0, DNA Fixer 0");
    await expect(page.getByTestId("open-treatment-rooms")).toHaveText("Open treatment rooms: 1");
    await expect(page.getByTestId("hospital-canvas-summary")).toContainText("rooms 3");
});
test("phase 7 slice 2 player journey: Jelly Vat can be built from browser controls", async ({ page }) => {
    ...
    await expect(page.getByTestId("action-status")).toHaveText("Action: room built");
    await expect(page.getByTestId("specialized-treatment-rooms")).toHaveText("Specialized rooms: pharmacy 0, specialist 0, Inflation Room 0, Slack Tongue Clinic 0, Fracture Clinic 0, Hair Restoration 0, Jelly Vat 1, DNA Fixer 0");
    await expect(page.getByTestId("open-treatment-rooms")).toHaveText("Open treatment rooms: 1");
    await expect(page.getByTestId("hospital-canvas-summary")).toContainText("rooms 3");
});
