...
test("phase 8 scenario import: DNA Fixer availability admits Alien DNA patients", async ({ page }) => {
    ...
    await canvas.click({ position: { x: 384, y: 160 } });
    await expect(page.getByTestId("action-status")).toHaveText("Action: room built");
    await expect(page.getByTestId("specialized-treatment-rooms")).toHaveText("Specialized rooms: pharmacy 0, Operating Theatre 0, specialist 0, Psychiatry 0, Inflation Room 0, Slack Tongue Clinic 0, Fracture Clinic 0, Hair Restoration 0, Jelly Vat 0, Decontamination 0, Electrolysis 0, DNA Fixer 1");
