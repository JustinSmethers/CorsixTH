...
import { expectCanvasNonBlank, phase8FixtureDirectory } from "./helpers/phase8-import";
...
async function expectOriginalUiStripNonBlank(page) {
    ...
    await expectCanvasNonBlank(page, "original-ui-strip-canvas");
}
...
async function expectMapPreviewNonBlank(page) {
    ...
    await expectCanvasNonBlank(page, "theme-map-preview-canvas", { mode: "rgb" });
}
...
async function expectBlockMapPreviewNonBlank(page) {
    ...
    await expectCanvasNonBlank(page, "theme-block-map-preview-canvas");
}
...
async function expectSpritePreviewNonBlank(page) {
    ...
    await expectCanvasNonBlank(page, "theme-sprite-preview-canvas");
}
...
async function expectAnimationPreviewNonBlank(page) {
    ...
    await expectCanvasNonBlank(page, "theme-animation-preview-canvas");
}
...
async function expectQDataPreviewNonBlank(page) {
    ...
    await expectCanvasNonBlank(page, "theme-qdata-preview-canvas");
}
